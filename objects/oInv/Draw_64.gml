...
{
	// EXP
	drawSetText(c_white,global.fIgnoreMod,fa_left,fa_middle)
	draw_text_transformed(300,130,"SOULS: "+string(oInv.souls),1,1,0);
	draw_text_transformed(300,180,"LEVELS: "+string(oInv.sodas),1,1,0);
