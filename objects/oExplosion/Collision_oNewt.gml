...
if (friendly = -1 ) or (friendly = 0 ) and point_in_circle(oNewt.x,oNewt.y,x,y, radius) and !collision_line(x, y, oNewt.x, oNewt.y-22, oCollide, 1, 0) and (image_index == 0) { playerHit(1)};
