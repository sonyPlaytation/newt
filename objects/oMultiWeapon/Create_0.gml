...
#region weapons
	...
	ds_map_add(weapons[6],"cooldown",1);
	...
	ds_map_add(weapons[12],"projectile",oShotHitscan);
	...
	ds_map_add(weapons[21],"startup",0);
	ds_map_add(weapons[21],"length",40);
	ds_map_add(weapons[21],"cooldown",8);
	ds_map_add(weapons[21],"bulletspeed",0);
	ds_map_add(weapons[21],"automatic",true);
